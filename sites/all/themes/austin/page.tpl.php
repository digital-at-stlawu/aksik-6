<?php
// $Id: page.tpl.php,v 1.14 2008/09/21 15:38:48 johnalbin Exp $
    ...
    <div id="header"><div id="header-inner" class="clear-block">
      ...
      <?php if ($logo or $site_name): ?>
        <div id="logo-title">
          ...
          <?php if ($post_state): ?>
            <div id="post-state"><?php print $post_state; ?></div>
          <?php endif; ?>
      ...
      <?php endif; ?>
          ...
          <?php if ($primary_links or $secondary_links or $navbar): ?>
        <div id="navbar"><div id="navbar-inner" class="region region-navbar<?php if ($promo or $mission) { print ' with-promo'; } ?>">
          ...
          <?php if ($is_front): ?>
            ...
            <?php if ($promo or $mission): ?>
            <div id="promo">
              <div id="promo-banner"><div id="promo-banner-inner" class="region region-promo">
              
                <?php if ($mission): ?>
                  <div id="mission"><?php print $mission; ?></div>
                <?php endif; ?>
                <?php print $promo; ?>
              </div></div></div> <!-- /#promo-banner-inner, /#promo-banner /#promo-->
            <?php endif; ?>
            
          <?php endif; ?>
          <?php if (!$is_front && !empty($breadcrumb)): ?>
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php if ($title or $tabs or $help or $messages): ?>
          <div id="content-header">
            ...
            <?php print $messages; ?>
            <?php if ($tabs): ?>
              <div class="tabs"><span class="author"><?php print t('Author tools: '); ?></span><?php print $tabs; ?></div>
            <?php endif; ?>
            <?php print $help; ?>
          </div> <!-- /#content-header -->
        <?php endif; ?>
